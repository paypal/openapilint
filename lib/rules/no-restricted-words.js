...
const description = 'enforce certain words are not included in text fields, including title, summary, or description';
...
const rule = {
  validate(options, schema) {
    ...
    return new RuleResult({ description, failures: getFailures(normalizedWords, schema) });
  }
};
