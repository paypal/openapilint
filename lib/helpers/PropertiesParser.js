  ...
  checkSchemaObject(propertyFunction, schemaObject, pathToSchema) {
    ...
    if (schemaObject.allOf) {
      schemaObject.allOf.forEach((allOfValue, allOfIndex) => {
        ...
        // Therefore, fake an object for the purposes of checking all properties.
        implicitAllOfValue.type = 'object';
        this.checkSchemaObject(propertyFunction, implicitAllOfValue, `${pathToSchema}.allOf[${allOfIndex}]`);
      });
    }
  }
